...
SYSTEMD_SETUP() {
  ...
  sed -i -e 's/MONGO_DNSNAME/dev-mongodb.rajashekar.online/' -e 's/REDIS_ENDPOINT/dev-redis.rajashekar.online/' -e 's/CATALOGUE_ENDPOINT/dev-catalogue.rajashekar.online/' -e 's/MONGO_ENDPOINT/dev-mongodb.rajashekar.online/' /home/roboshop/${COMPONENT}/systemd.service &>>$LOG
